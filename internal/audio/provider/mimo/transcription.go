...
func parseTranscriptionConfig(cfg map[string]any) transcriptionConfig {
...
// TranscriptionProvider implements sdk.TranscriptionProvider for Xiaomi MiMo ASR.
...
func NewTranscription(opts ...Option) *TranscriptionProvider {
...
func (p *TranscriptionProvider) TranscriptionModel(id string) *sdk.TranscriptionModel {
	if id == "" {
...
func (p *TranscriptionProvider) ListModels(context.Context) ([]*sdk.TranscriptionModel, error) {
	return []*sdk.TranscriptionModel{p.TranscriptionModel(defaultTranscriptionModel)}, nil
}

func (p *TranscriptionProvider) DoTranscribe(ctx context.Context, params sdk.TranscriptionParams) (*sdk.TranscriptionResult, error) {
	...
	cfg := parseTranscriptionConfig(params.Config)

	dataURL := buildAudioDataURL(params.Audio, params.ContentType, params.Filename)
	...
	return decodeTranscriptionResponse(body)
}
...
func decodeTranscriptionResponse(body []byte) (*sdk.TranscriptionResult, error) {
